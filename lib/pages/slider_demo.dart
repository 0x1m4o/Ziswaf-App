                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            const Center(
                              child: Image(
                                image: AssetImage(
                                  'assets/images/IllustrasiSplashScreen1.png',
                                ),
                                height: 343.0,
                                width: 343.0,
                              ),
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            const Center(
                              child: Image(
                                image: AssetImage(
                                  'assets/images/IllustrasiSplashScreen2.png',
                                ),
                                height: 343.0,
                                width: 343.0,
                              ),
                            ...
                            const SizedBox(height: 16.0),
                            Text(
                              'Buat Program dari hasil donasi',
                              style: h2ExtraBold,
                            ),
                            const SizedBox(height: 24.0),
                            Text(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            const Center(
                              child: Image(
                                image: AssetImage(
                                  'assets/images/IllustrasiSplashScreen3.png',
                                ),
                                height: 343.0,
                                width: 343.0,
                              ),
                            ...
                            const SizedBox(height: 16.0),
                            Text(
                              'Monitor target pencapaian program',
                              style: h2ExtraBold,
                            ),
                            const SizedBox(height: 24.0),
                            Text(
